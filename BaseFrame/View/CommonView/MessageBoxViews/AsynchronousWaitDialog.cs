...
namespace BaseFrame.View.MessageBoxViews
{
    ...
    /// }
    /// or:
    /// AsynchronousWaitDialog.ShowWaitDialogForAsyncOperation("title", Action&lt;IProgressMonitor&gt;); //显示模态窗体。
    /// </summary>
    public sealed class AsynchronousWaitDialog : IProgressMonitor
    {
        ...
        bool CreateDialogForm()
        {
            ...
            dlg.SetAllowCancel(cancellation != null);
            dlg.Text = titleName;
        ...
        void Utility.MessageService.IProgress<double>.Report(double value)
        {
            this.Progress = value;
        }
